...
import { convertDocxToPdf } from '@/lib/pdf-word-engine';
...
export default function WordToPdfPage() {
  ...
  const [downloadName, setDownloadName] = useState('converted-document.pdf');
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast.error(err?.message || 'Failed to convert Word document to PDF.');
    } finally {
  ...
  return (
    <ToolLayout
      ...
      subtitle="Convert Microsoft Word (.docx) documents to PDF format directly in your browser. 100% free with zero server uploads."
    >
      <div className="space-y-5">
        <FileUploader
          ...
          title="Upload Word (.docx) document to convert to PDF"
